...
- enables scheduling by time interval
- enables scheduling by [cron](https://crontab.cronhub.io/) expressions
...
- enables ad-hoc job runs for manual/recovery scenarios
